...
w = m.Wafer('NANJ01_02_parent_des','DXF/',7000,7000,padding=500,waferDiameter=55000,sawWidth=200,#m.sawL_ws['8A'],
...
for i in range(len(w.chips)):
    ...
    w.add(dxf.text('NbRes1',vadd(w.chipPts[i],(1200,6600)),height=600,layer='LABEL1'))
