...
w = m.Wafer('NAN43_Jarray_v1','DXF/',7000,7000,padding=500,waferDiameter=55000,sawWidth=200,#m.sawL_ws['8A'],
...
for i in range(len(w.chips)):
    ...
    w.add(dxf.text('43D',vadd(w.chipPts[i],(1200,6600)),height=240,layer='MARKERS'))
