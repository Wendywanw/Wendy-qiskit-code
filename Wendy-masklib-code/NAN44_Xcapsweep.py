...
w = m.Wafer('NAN44_XCapSweep_v1','DXF/',7000,7000,padding=500,waferDiameter=55000,sawWidth=200,#m.sawL_ws['8A'],
...
waffle(jelly6, 100, width=20,bleedRadius=1,padx=700,layer='XOR2',exclude=['BASEMETAL','SECONDLAYER'])
jelly6.save(w)
...
for i in range(len(w.chips)):
    ...
    w.add(dxf.text('44X',vadd(w.chipPts[i],(1200,6600)),height=240,layer='MARKERS'))
