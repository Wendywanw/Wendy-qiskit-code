...
class DolanJunctionBandage(QComponent):
    ...
    def make(self):
        ...
        jj_gap = p.jj_gap
        finger_length = total_height - jj_gap - d_pin*2
        top_finger_len = finger_length/2-top_bot_offset
        bot_finger_len = finger_length/2+top_bot_offset
        ...
        finger_u = rec2(max(w_top_u,w_bot_u), finger_length)
